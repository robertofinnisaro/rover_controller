...
class Controller(Node):
  ...
  def __init__(self):
    ...
    # over a topic named: /rover/state_est
    ...
    # robot chassis coordinate frame) to the /rover/cmd_vel topic. Using the diff_drive
    # plugin enables the robot model to read this /rover/cmd_vel topic and execute
    ...
    self.dist_thresh_wf = 1 # in meters  
  ...
  def state_estimate_callback(self, msg):
    ...
    a new message is received on the '/rover/state_est' topic
    """
  ...
  def scan_callback(self, msg):
    ...
    received on the '/rover/laser/out' topic 
    """
    ...
    self.left_dist = msg.ranges[713]
    self.leftfront_dist = msg.ranges[534]
    self.front_dist = msg.ranges[356]
    self.rightfront_dist = msg.ranges[178]
  ...
  def follow_wall(self):
    ...
    print(self.wall_following_state)
